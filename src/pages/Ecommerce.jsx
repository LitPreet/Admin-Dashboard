        ...
        <div className=" bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center ">
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className="text-2xl">$66,345.78</p>
            </div>
          </div>
...
<div>
  <p>
    <span className="text-3xl font-semibold ">$92,456</span>
    <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white text-xs ml-3 bg-green-400">23%</span>
  </p>
  ...
  <div className="mt-8">
  <p>
    <span className="text-3xl font-semibold ">$37,456</span>
